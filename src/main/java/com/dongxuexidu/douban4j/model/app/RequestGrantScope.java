...
public class RequestGrantScope {
    ...
    public static final String SCOPE_MAIL_READ = "community_advanced_doumail_r";
    public static final String SCOPE_MAIL_WRITE = "community_advanced_doumail_w";
    public static final String SCOPE_BASIC_NOTE = "community_basic_note";

    public static final String SCOPE_BOOK_READ = "book_basic_r";
    public static final String SCOPE_BOOK_WRITE = "book_basic_w";

    public static final String SCOPE_MOVIE_READ = "movie_basic_r";
    public static final String SCOPE_MUSIC_READ = "music_basic_r";
    public static final String SCOPE_EVENT_READ = "event_basic_r";
    public static final String SCOPE_EVENT_WRITE = "event_basic_w";
    ...
    public static final RequestGrantScope BOOK_WRITE_SCOPE = new RequestGrantScope("BookWrite", RequestGrantScope.SCOPE_BOOK_WRITE, "豆瓣读书");
